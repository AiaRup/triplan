          ...
          <div className="container">
            <div className="row">
              <div className="col-md-3">
                ...
                <div className='icons'>
                  <a className="linkedinIcon" href="https://www.linkedin.com/in/dror-dvash/" target="_blank">
                    <i className="fa fa-linkedin"></i>
                  </a>
                  <a className="gitIcon" href="https://github.com/dvash999" target="_blank" >
              ...
              <div className="col-md-3">
                ...
                <div className='icons'>
                  <a className="linkedinIcon" href="https://www.linkedin.com/in/hodaya-p/" target="_blank">
                    <i className="fa fa-linkedin"></i>
                  </a>
                  <a className="gitIcon" href="https://github.com/hodaya55" target="_blank" >
                    <i className="fa fa-github"></i>
                  </a>
                </div>
