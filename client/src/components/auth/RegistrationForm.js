...
export default withAuth(
  ...
  class RegistrationForm extends React.Component {
    constructor(props) {
      ...
      //   url: "https://dev-497398.oktapreview.com"
      // });
      this.oktaAuth = new OktaAuth({ url: "https://dev-789825.okta.com" });
                  ...
                  <div className="signin-container">
                    <div className="content">
                      ...
                      <span
                        ...
                        onClick={this.props.toggleLoginRegister}
                      >
                        Sign in
                      </span>
                    </div>
